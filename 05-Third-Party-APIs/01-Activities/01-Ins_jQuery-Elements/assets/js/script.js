...
//jQuery, go select the element with the id "root"
var rootEl = $('#root');

// var titleEl = document.createElement("h1");
var titleEl = $('<h1>'); //creates an h1 tag and stores it under the name titleEl
...
rootEl.append(titleEl); //prepend is the first
